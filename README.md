...
*University of Toronto · Vector Institute · Max Planck Institute for Intelligent Systems*

[Project Page](https://gudmorning2025.github.io/Stargazer/) · [Paper (preprint)](#citation)
...
Code is released under the LICENSE in this repository. Benchmark task data follows CC-BY-4.0; if you use the dataset, please also cite the original archival RV publications referenced in `stargazer/Stargazer_real_data_task/`.
